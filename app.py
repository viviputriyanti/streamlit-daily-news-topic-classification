...
# --- PERBAIKAN UTAMA: Membuat kolom baru di awal untuk menghindari SettingWithCopyWarning ---
...
with tab1:
    if not df_filtered.empty:
        try:
            ...
            # PERBAIKAN UTAMA: Baris yang menyebabkan warning sudah dihapus dari sini.
            # Kita sekarang langsung menggunakan kolom 'panjang_artikel' yang sudah dibuat di awal.
